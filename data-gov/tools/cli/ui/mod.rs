...
impl CliStatusReporter {
    fn new(color_helper: ColorHelper) -> Self {
    ...
    fn display_name(&self, resource_name: &Option<String>, output_path: &PathBuf) -> String {
    ...
    fn progress_key(path: &PathBuf) -> String {
...
fn execute_command(
    ...
    match command {
        ...
        ReplCommand::List { what } => match what.to_lowercase().as_str() {
            "organizations" | "orgs" => {
